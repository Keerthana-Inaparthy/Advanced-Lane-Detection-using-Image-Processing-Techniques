...
class LaneLines:
    ...
    def __init__(self):
        ...
        #pygame.mixer.init()
        #self.beep_sound = "beep.wav"
        self.left_turn_audio = "left_turn.wav"
        self.right_turn_audio = "right_turn.wav"
        self.audio_events = []
    ...
    def plot(self, out_img, frame_time):

        #beep_audio = AudioFileClip("beep.mp3")
        ...
        if direction != self.last_direction:
            ...
            if direction == 'L':
                pygame.mixer.Sound(self.left_turn_audio).play()
                self.audio_events.append((frame_time, 'L'))
            elif direction == 'R':
                pygame.mixer.Sound(self.right_turn_audio).play()
                self.audio_events.append((frame_time, 'R'))
            #pygame.mixer.Sound(self.beep_sound).play()
        msg = "Go Straight"
        ...
        if direction == 'L':
            ...
            #if not self.dir or self.dir[-1] != 'L':
             #   play_beep = True
